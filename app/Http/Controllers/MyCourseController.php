...
class MyCourseController extends ACMBaseController
{
    ...
    public function indexTutor(Request $request){
        ...
        ->whereIn('learner_schedule.status_sch_id',[5,6])
       ...
       // dd($this->theme);
        return $this->theme->scope('home.mycourse_tutor')->render();
    }
    public function indexLearner(Request $request){
        ...
        ->whereIn('tutor_schedule.status_sch_id',[5,6])
       ...
       // dd($this->theme);
        return $this->theme->scope('home.mycourse_learner')->render();
    }
